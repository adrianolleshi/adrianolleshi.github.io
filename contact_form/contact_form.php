...
// configure
$from = 'adriano@heyyytaxi.al'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'adrianolleshi1@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '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';
